...
// ...Full JS code continues here from your original Astra AI chatbot logic...
...
function takeCommand(message) {
    ...
    navigator.mediaDevices.getDisplayMedia({ video: true }).then(stream => {
        ...
        return imageCapture.grabFrame().then(bitmap => {
            ...
            canvas.toBlob(blob => {
                ...
                a.click();
                typeMessage("Screenshot taken and downloaded.");
            });
        ...
        typeMessage("Failed to take screenshot. Please allow screen capture.");
  ...
  else if (message.includes("screenshot") || message.includes("take a screenshot")) {
    typeMessage("Taking Screenshot");
    takeScreenshot();
  }
